...
<div class="container">
    ...
    <form method="post">
        <div class="input-group">
            ...
            <input type="text" class="form-control" name="courses" id="courses" value="<?php echo $_POST['courses']; ?>"/>
        </div>
        <br>
        <div class="input-group">
            <label for="digits">
        ...
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="filter" id="filter" value="yes" <?php if (isset($_POST["filter"])) echo "checked"; ?>>
        ...
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="chem" id="chem" value="yes" <?php if (isset($_POST["chem"])) echo "checked"; ?>>
            <label class="form-check-label" for="chem">
                Include courses that require chemistry classification
            </label>
            <br>

            <input class="form-check-input" type="checkbox" name="phys1" id="phys1" value="yes" <?php if (isset($_POST["phys1"])) echo "checked"; ?>>
            <label class="form-check-label" for="phys1">
                Include courses that require physics classification for mechanics
            </label>
            <br>

            <input class="form-check-input" type="checkbox" name="phys2" id="phys2" value="yes" <?php if (isset($_POST["phys2"])) echo "checked"; ?>>
...
function check_kdamim($course_string, $user_string) {
...
foreach ($data as $course) {
    if (substr($course["general"]["מספר מקצוע"], 0, 3) == $digits || $digits == "***") {
        ...
        if (!isset($course["general"]["מקצועות קדם"]) || check_kdamim($course["general"]["מקצועות קדם"], trim($_POST["courses"] . $classifications))) {
            echo "<tr>";
